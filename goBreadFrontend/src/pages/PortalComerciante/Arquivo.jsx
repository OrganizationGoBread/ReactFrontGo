...
function Arquivo() {
    ...
    const handleDownload = async () => {
        try {
            ...
            const response = await axios.get(`http://18.212.221.247:8080/comercios/download/clientes-txt/${idComercio}`, {
                responseType: 'blob',
            });
    ...
    const handleUpload = async () => {
        try {
            ...
            await axios.post('http://18.212.221.247:8080/comercios/upload/produtos-txt', formData, {
                headers: {
